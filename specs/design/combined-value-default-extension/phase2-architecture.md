...
The resolution records explicit delegation to the extended value and tests for consistent defaults. The source therefore has no independent solution boundary to design. This record points implementers to `specs/design/value-type-system/` and deliberately omits Phases 3 and 4.

## Risk Review

| Risk | Assessment | Containment |
|---|---|---|
| Reopening a finished design | Historical decisions could be contradicted. | Do not modify `value-type-system`; retain this separate coverage record only. |
