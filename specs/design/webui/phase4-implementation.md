...
**Files:** `CLAUDE.md`, `specs/design/webui/DESIGN.md`, optionally `specs/reference/PROJECT_OVERVIEW.md`
...
milestone and record status in `specs/design/webui/DESIGN.md`.

## Documentation Updates
- **CLAUDE.md** — UI section: the `egui`/`webui` features and `render_web`/`show_in_web` methods (new pattern).
- **specs/design/webui/DESIGN.md** — mark phases complete.
