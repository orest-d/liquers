...
- `specs/design/expiration-mechanism/`, `specs/design/expiration-monitor-assetref/` (prior related designs)
- `specs/design/async-wasm-refactor/` (landed on `main` during this design's Phase 4 — see sync note above)
