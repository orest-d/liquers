# `COMMAND-DECLARATION-FORMAT` — Phase 1 and Phase 2

Prepared under [`guides/autonomous_issue_fixing.md`](../../guides/autonomous_issue_fixing.md) for
[`issues/COMMAND-DECLARATION-FORMAT.md`](../../issues/COMMAND-DECLARATION-FORMAT.md) (feature, P0 by
maintainer decision, complexity M). Recorded here because the issue links to this design; nothing in
this file changes the `environment-builder` phase documents or its workflow contract.
