...
The resolution records cfg-gating the import and create branch with a feature-matrix check. The source therefore has no independent solution boundary to design. This record points implementers to `specs/design/opendal-path-mapping/` and deliberately omits Phases 3 and 4.
