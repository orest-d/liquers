...
- **Phase 1 Design:** `/specs/design/axum-assets-recipes-api/phase1-high-level-design.md`
- **Phase 2 Architecture:** `/specs/design/axum-assets-recipes-api/phase2-architecture.md`
