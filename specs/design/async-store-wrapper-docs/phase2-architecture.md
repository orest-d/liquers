...
Replace obsolete synchronous-store examples with AsyncMemoryStore and correct the unittest skill imports.

## Integration Boundary

**Files and symbols:** CLAUDE.md, specs/guides/UNITTEST_GUIDE.md, specs/reference/STORE_CONFIG_FSD.md, .claude/skills/liquers-unittest/SKILL.md. Reuse existing typed Error constructors and existing async traits; avoid new ownership or dispatch abstractions unless the named boundary requires them. Serialized additions are optional and additive; public Rust renames retain explicit compatibility handling where stated.
