...
- **Architecture:** `specs/design/web-api-library/phase2-architecture.md` (implementation)
- **Error spec:** `specs/design/web-api-library/phase2-architecture.md` section "Error Handling"
- **Formats:** `specs/design/web-api-library/phase2-architecture.md` section "Serialization Strategy"
