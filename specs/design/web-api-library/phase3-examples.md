...
- `specs/design/web-api-library/phase1-high-level-design.md` - Feature design
- `specs/design/web-api-library/phase2-architecture.md` - Implementation architecture
