...
- **Knowledge:** `liquers-core/src/error.rs`, `specs/design/dependency-management/phase2-architecture.md` (Error Handling section), `specs/design/dependency-management/phase3-examples.md` (ErrorType usage in examples)
...
- **Model:** haiku
- **Skills:** rust-best-practices
- **Knowledge:** `liquers-core/src/command_metadata.rs` (CommandMetadata struct at line 703, add_command at line 951), `specs/design/dependency-management/phase2-architecture.md` (command_metadata.rs section)
...
- **Knowledge:** `specs/design/dependency-management/phase2-architecture.md` (full), `specs/design/dependency-management/phase3-examples.md` (unit tests section), `liquers-core/src/metadata.rs` (Version, DependencyKey, DependencyRecord already defined here), `liquers-core/src/assets.rs` (AssetRef, WeakAssetRef), `liquers-core/src/error.rs` (for Error constructors), `liquers-core/Cargo.toml`
...
- **Model:** haiku
- **Skills:** rust-best-practices
- **Knowledge:** `liquers-core/src/metadata.rs` (MetadataRecord struct), `specs/design/dependency-management/phase2-architecture.md` (MetadataRecord section)
...
- **Model:** sonnet
- **Skills:** rust-best-practices
- **Knowledge:** `liquers-core/src/plan.rs` (lines 1518–1800, find_dependencies + callers), `specs/design/dependency-management/phase2-architecture.md` (plan.rs section + DependencyRelation variants), `liquers-core/src/dependencies.rs` (DependencyRelation, PlanDependency, DependencyKey)
...
- **Model:** haiku
- **Skills:** rust-best-practices
- **Knowledge:** `liquers-lib/src/commands.rs` (existing command registration patterns), `specs/guides/COMMAND_REGISTRATION_GUIDE.md`, `specs/reference/REGISTER_COMMAND_FSD.md`, `specs/archive/2026-08-08-issues.md` (context parameter position bug), `specs/design/dependency-management/phase2-architecture.md` (dep namespace + command_metadata.rs sections), `liquers-core/src/command_metadata.rs` (CommandMetadata struct with new version fields from Step 1b)
...
TODO: `specs/guides/COMMAND_REGISTRATION_GUIDE.md` and `specs/reference/REGISTER_COMMAND_FSD.md` needs to be updated to explain `command_version` macro and recommend to always use it together with `version: auto`.
...
- **Model:** haiku
- **Skills:** rust-best-practices, liquers-unittest
- **Knowledge:** `liquers-core/tests/async_hellow_world.rs` (full integration test pattern), `specs/design/dependency-management/phase3-examples.md` (Integration Tests section), `liquers-core/src/assets.rs` (DefaultAssetManager API), `liquers-core/src/dependencies.rs` (just written)
...
- `specs/design/dependency-management/DESIGN.md` — mark all phases complete after implementation
