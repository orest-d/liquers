...
The resolution records that both defaults now test each child before recursion. The source therefore has no independent solution boundary to design. This record points implementers to `specs/design/store-conformance-suite/` and deliberately omits Phases 3 and 4.
