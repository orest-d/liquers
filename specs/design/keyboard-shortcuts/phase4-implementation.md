...
- `specs/design/keyboard-shortcuts/DESIGN.md` (update status)
...
**Code changes:**
```markdown
# MODIFY: specs/design/keyboard-shortcuts/DESIGN.md
...
**Rollback:**
```bash
git restore specs/design/keyboard-shortcuts/DESIGN.md
