...
The resolution records folding recipe declarations into the plan and a dependency-registration regression test. The source therefore has no independent solution boundary to design. This record points implementers to `specs/design/predecessor-cut-equivalence/` and deliberately omits Phases 3 and 4.
