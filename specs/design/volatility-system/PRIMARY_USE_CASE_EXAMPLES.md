...
- **Phase 1 Design**: See `specs/design/volatility-system/phase1-high-level-design.md`
- **Phase 2 Architecture**: See `specs/design/volatility-system/phase2-architecture.md`
