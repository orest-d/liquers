...
**OUTPUT:** Create a document listing all direct PlanBuilder usage sites with assessment. Save as `specs/design/volatility-system/planbuilder-audit.md`.
...
cat specs/design/volatility-system/planbuilder-audit.md
```

**Rollback:**
```bash
# No code changes, just documentation
rm specs/design/volatility-system/planbuilder-audit.md
```
...
**File:** `specs/design/volatility-system/phase2-architecture.md`
