...
**Files:** `specs/archive/2026-08-08-issues.md`, `specs/design/webui/DESIGN.md`, `specs/design/webui-fixes/DESIGN.md`,
...
- Note that W1, W2 and W5 now live in `specs/design/ui-events/`.
- `specs/design/webui-fixes/DESIGN.md` → Implementation Complete.
...
**Agent:** haiku · knowledge: `specs/archive/2026-08-08-issues.md`, `specs/design/async-wasm-refactor/DESIGN.md`.
...
- `specs/archive/2026-08-08-issues.md` — W3 resolved, W4 closed, W1/W2/W5 pointed at `specs/design/ui-events/` (step 11).
- `specs/design/webui/DESIGN.md` — note that rendering now follows model changes.
- `specs/design/webui-fixes/DESIGN.md` — phase tracking → Implementation Complete.
