...
interaction half (W1, W2, W5) moved to `specs/design/ui-events/`, which is its own phased design. What
...
Explicitly **not** here (moved to `specs/design/ui-events/`): W1 (Enter does not submit), W2 (submitted
...
- `specs/design/ui-events/` — the interaction half of the original design (W1, W2, W5)
- `specs/design/webui/` — the original webui feature design
- `specs/design/async-wasm-refactor/DESIGN.md` — evidence that W4 is resolved
