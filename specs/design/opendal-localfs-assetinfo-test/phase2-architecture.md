...
The resolution records a let-else assertion and a concrete filename assertion. The source therefore has no independent solution boundary to design. This record points implementers to `specs/design/opendal-path-mapping/` and deliberately omits Phases 3 and 4.
