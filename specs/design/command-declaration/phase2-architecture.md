...
| Assessment | Record |
|---|---|
| **Documentation** | [`COMMAND_DECLARATION.md`](../../reference/COMMAND_DECLARATION.md) is the completed Phase 5 deliverable in `specs/reference/`. `LANGUAGE-INTEGRATION_GUIDE.md` §COMMAND and §8 point at it. A section on writing an integration's *user* documentation is missing and filed as `LANGUAGE-GUIDE-NO-DOCUMENTATION-SECTION`. |
