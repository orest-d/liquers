...
- **Model:** haiku
- **Skills:** rust-best-practices
- **Knowledge:** `liquers-lib/src/commands.rs` (existing command registration patterns), `specs/guides/COMMAND_REGISTRATION_GUIDE.md`, `specs/reference/REGISTER_COMMAND_FSD.md`, `specs/archive/2026-08-08-issues.md` (context parameter position bug), `specs/dependency-management/phase2-architecture.md` (dep namespace + command_metadata.rs sections), `liquers-core/src/command_metadata.rs` (CommandMetadata struct with new version fields from Step 1b)
