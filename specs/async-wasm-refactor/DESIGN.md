...
- **M-E/M-F REMAINING:** M-E `trunk build` + Playwright e2e (runtime acceptance in headless Chromium — needs `trunk`/`@playwright/test` tooling); M-F docs/ISSUES/PROJECT_OVERVIEW.
